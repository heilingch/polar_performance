...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Add new variables for UDP timeout detection
        self.udp_no_data_counter = 0
        self.udp_stream_stopped = False
        self.last_udp_update_time = 0  # Initialize last update time for UDP
    ...
    def update_udp_data(self):
        if self.udp_network_reader is not None:
            ...
            # Handle Event logging when data stream stops or recovers
